  ...
  const LaboratoryTestList = () => {
    ...
    const handleLaboratoryTestSubmit = async () => {
      ...
      try {
        const url = isEditMode
          ? `http://localhost:3001/api/laboratorytest-list/${editableLaboratoryTest._id}`
          : "http://localhost:3001/api/laboratorytest-list";
    ...
    const handleDeleteLaboratoryTest = async () => {
      try {
        await axios.delete(`http://localhost:3001/api/laboratorytest-list/${testToDelete._id}`);
        setLaboratoryTests((prevTests) =>
