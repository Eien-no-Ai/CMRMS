        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white py-4 px-6 rounded-lg w-4/5 h-4/5 shadow-lg max-w-5xl overflow-y-auto flex flex-col relative">
            ...
            <form className="flex-grow">
              ...
              {Object.entries(formData.testResults || {}).map(([categoryName, tests], catIndex) => (
        ...
        <div className="ml-4 space-y-2">
          ...
          {typeof testValue.result === "string" ? (
            <div className="flex items-center gap-4">
              <label className="min-w-[150px] text-sm font-medium">Result</label>
              <input
                type="text"
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...
                    testResults: {
                      ...prev.testResults,
                      [categoryName]: {
                        ...prev.testResults[categoryName],
                        [testName]: {
                          ...prev.testResults[categoryName][testName],
            ...
            // Otherwise, assume it's a subtest group
            Object.entries(testValue).map(([subTest, subValue], subIndex) =>
              subTest !== "referenceRange" ? (
                <div key={subIndex} className="flex items-center gap-4 text-sm">
                  <div className="min-w-[150px] font-semibold">{subTest}</div>
                  <input
                    type="text"
                    value={subValue}
                    onChange={(e) =>
