...
//       // 🔍 Log full lab details to the console
//       console.log("Fetched Lab Result Details:", data);

//       setLabDetails(data); // Set full lab details

//       // Set requested categories based on which fields are non-empty
//       const categories = [];

//       if (data.bloodChemistry && hasNonEmptyFields(data.bloodChemistry)) {
//         categories.push("Blood Chemistry");
//       }
//       if (data.Hematology && hasNonEmptyFields(data.Hematology)) {
//         categories.push("Hematology");
//       }
//       if (
//         data.clinicalMicroscopyParasitology &&
//         hasNonEmptyFields(data.clinicalMicroscopyParasitology)
//       ) {
//         categories.push("Clinical Microscopy and Parasitology");
//       }
//       if (
//         data.bloodBankingSerology &&
//         hasNonEmptyFields(data.bloodBankingSerology)
//       ) {
//         categories.push("Serology");
//       }
...
//       // Set visibility states for category-based conditional rendering
//       setIsBloodChemistryVisible(categories.includes("Blood Chemistry"));
//       setHematologyVisible(categories.includes("Hematology"));
//       setClinicalMicroscopyVisible(
//         categories.includes("Clinical Microscopy and Parasitology")
...
//       // 🧠 Build dynamic test results for display
//       const dynamicTestResults = {};

//       const categoryMap = {
//         bloodChemistry: "Blood Chemistry",
//         Hematology: "Hematology",
//         clinicalMicroscopyParasitology: "Clinical Microscopy and Parasitology",
//         bloodBankingSerology: "Serology",
//       };

//       Object.entries(categoryMap).forEach(([rawKey, displayName]) => {
//         const tests = data[rawKey];
//         if (tests && typeof tests === "object") {
//           dynamicTestResults[displayName] = {};

//           Object.entries(tests).forEach(([testName, testData]) => {
//             dynamicTestResults[displayName][testName] = testData;
//           });
//         }
//       });

//       // ⬇️ Set the dynamic test results into formData
//       setFormData((prev) => ({
//         ...prev,
//         testResults: dynamicTestResults,
//       }));

//       setIsModalOpen(true); // ✅ Open the modal now that everything is ready
//     } else {
//       alert("No laboratory result found for this request ID.");
//     }
//   } catch (error) {
...
{searchQuery || showFullList ? (
  <div>
    ...
    <div className="flex justify-between items-center mt-4">
      ...
      {/* Modal for Viewing Details hiii*/}
