        ...
        <table style="width: 100%; border-collapse: collapse; border: 1px solid #000; margin-top: 50px;">
          <thead>
            <tr>
              ...
              <th style="padding: 8px; text-align: left; border: 1px solid #000;">Clinical Records</th>
              <th style="padding: 8px; text-align: left; border: 1px solid #000;">PE Students Completed</th>
              <th style="padding: 8px; text-align: left; border: 1px solid #000;">Hepatitis A Vaccine</th>
              <th style="padding: 8px; text-align: left; border: 1px solid #000;">Hepatitis B Vaccine</th>
              <th style="padding: 8px; text-align: left; border: 1px solid #000;">Influenza Vaccine</th>
              <th style="padding: 8px; text-align: left; border: 1px solid #000;">Pneumonia Vaccine</th>
            </tr>
          </thead>
          <tbody>
            <tr>
