...
const clinicalRecords = [
  { date: "12 Dec '19", complaints: "Headache", treatment: "Paracetamol", diagnosis: "Headache" },
  { date: "12 Dec '19", complaints: "Headache", treatment: "Paracetamol", diagnosis: "Headache" },
  { date: "12 Dec '19", complaints: "Headache", treatment: "Paracetamol", diagnosis: "Headache" },
];
...
function PatientsProfile() {
  ...
  const displayedRecords =
    selectedTab === "clinical" ? clinicalRecords :
    selectedTab === "laboratory" ? laboratoryRecords :
    xrayRecords;
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm lg:col-span-2">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="text-center">
                ...
                />
                <h2 className="mt-4 text-xl font-semibold">{patient.firstname} {patient.lastname}</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold">{new Date(patient.birthdate).toLocaleDateString()}</p>
                </div>
                <div>
